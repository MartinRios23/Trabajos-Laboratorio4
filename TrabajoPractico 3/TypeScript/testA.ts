...
export class TestA {
  ...
  asignarValores(){
    ...
    this.hojaRuta1.detalles.push(detalle1);
    this.hojaRuta1.detalles.push(detalle2);
    this.hojaRuta1.detalles.push(detalle3);

    this.hojaRuta2.detalles.push(detalle4);
    this.hojaRuta2.detalles.push(detalle5);
    this.hojaRuta2.detalles.push(detalle6);

    this.hojaRuta3.detalles.push(detalle7);
    this.hojaRuta3.detalles.push(detalle8);
    this.hojaRuta3.detalles.push(detalle9);
